defmodule GrasstubeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GrasstubeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GrasstubeWeb.Gettext, "errors", msg, opts)
    end
  end
