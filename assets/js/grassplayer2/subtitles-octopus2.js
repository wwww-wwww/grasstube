...
export default class SubtitlesOctopus extends EventTarget {
  ...
  constructor(options = {}) {
    ...
    this._proxyCanvas = options.proxyCanvas
    this._canvasParent = options.canvasParent
    if (this._video) {
  ...
  _getVideoPosition() {
    ...
    const rect = this._proxyCanvas.getBoundingClientRect()
  ...
  setVideo(video) {
    if (video instanceof HTMLVideoElement) {
      ...
      if (typeof ResizeObserver !== 'undefined') {
        ...
        this._ro.observe(this._proxyCanvas)
      }
    } else {
